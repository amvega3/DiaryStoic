...
<div class="bg-black">
    <div class="absolute top-0 right-0 ">
        <form method="POST" action="{{ route('logout') }}" x-data>
            ...
            <x-jet-responsive-nav-link class="text-[#FFC600] text-xl hover:bg-transparent hover:text-white" href="{{ route('logout') }}"
                           @click.prevent="$root.submit();">
                {{ __('Salir') }}
            </x-jet-responsive-nav-link>
        </form>
    </div>
    <nav x-data="{ open: false }" class="bg-[#FFC600]  pr-2 pl-2 pb-4  border fixed  left-0 flex
    text-black text-2xl  bottom-0  h-22 p-2  w-full ">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
            ...
            <div class="flex justify-between h-16 ">
                ...
                <div class="hidden sm:flex left-0 sm:items-center sm:ml-6">
                    <!-- Teams Dropdown -->
    ...
    {{-- <div class="ml-3 flex realitive mx-auto  ">
        <x-jet-dropdown class="" align="bottom" width="48">
            <x-slot name="trigger">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            ...
            <x-slot name="content" class=" flex top-0">
                <!-- Account Management -->
                <div class="block px-4 py-2 text-xs text-gray-400">
                    {{ __('Manage Account') }}
                </div>
